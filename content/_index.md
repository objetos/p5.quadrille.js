...
{{< figure src="p5.quadrille.js.png" caption="***Paintings sorted according to their luma using quadrille [sort]({{< relref sort >}})***" alt="Paintings sorted by luma using quadrille.sort()" >}}
