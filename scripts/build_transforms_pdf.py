...
PATHS = [
    "docs/transforms/",        # section index
    "docs/transforms/reflect/",
    "docs/transforms/rotate/",
    "docs/transforms/transpose/",
]

OUT = "transforms-section.pdf"
...
async def main():
    tmp = Path(".playwright-transforms-tmp")
