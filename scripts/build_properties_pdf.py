...
PATHS = [
    ...
    # Read-Only subtree (index + pages, in the given order)
    "docs/properties/read_only/",
    "docs/properties/read_only/mouse_row/",
    "docs/properties/read_only/mouse_col/",
    "docs/properties/read_only/size/",
    "docs/properties/read_only/order/",

    # Read-Write subtree (index + pages, in the given order)
    "docs/properties/read_write/",
    "docs/properties/read_write/width/",
    "docs/properties/read_write/height/",
    "docs/properties/read_write/memory_2d/",
]

OUT = "properties-section.pdf"
...
async def main():
    tmp = Path(".playwright-properties-tmp")
