...
function draw() {
  ...
  //quadrilleParams.cells = [c1, c2, c3];
  quadrilleParams.cells = [null, null, c1, c2, c3];
  //quadrilleParams.tileDisplay = 0;
  console.log(quadrilleParams.cells);
  //console.log(quadrilleParams.cells.length);
  //quadrilleParams.cells = [null];
  //console.log(quadrilleParams.cells);
  if (quadrille) drawQuadrille(quadrille, quadrilleParams);
}
